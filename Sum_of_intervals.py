...
The sum of the lengths of these intervals is 7. Since [1, 4] and [3, 5] overlap, we can
treat the interval as [1, 5], which has a length of 4.
...
def sum_of_intervals(intervals):
    overlap = []
    for i in intervals:
        current_range = [*range(i[0], i[1])]  # first time learning about the packing/unpacking
        # operator in python!
